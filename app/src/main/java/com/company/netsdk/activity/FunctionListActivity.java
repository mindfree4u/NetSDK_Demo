            ...
            switch (position) {
               ...
               case 6:
                ...
                case 9:
                    ...
                    break;
//                case 10:
//                    startActivity(RealLoadPictureActivity.class);
//                    break;
//                case 11:
//                    startActivity(TestInterfaceActivity.class);
//                    break;
//                case 10:
//                    startActivity(TrafficAllowListActivity.class);
//                    break;
...
//        data.add(res.getString(R.string.activity_function_list_real_load_picture));
//        data.add(res.getString(R.string.activity_function_lise_interface_test));
//        data.add(res.getString(R.string.function_list_traffic_allow_list));
