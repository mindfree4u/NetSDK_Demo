...
public class PTZControl {
     ...
     * @return
     */
    public static boolean ptzControlLamp(long loginHandle, int nChn, byte param1) {
     ...
     * @param nChn         通道号
     * @param param1       灯光控制器地址
     * @param param2       灯光好
     * @param param3       开关
     * @return
     */
    public boolean ptzControlLight(long loginHandle, int nChn, byte param1, byte param2, byte param3) {
        return INetSDK.SDKPTZControl(loginHandle, nChn, SDK_EXTPTZ_ControlType.SDK_EXTPTZ_LIGHTCONTROL, param1, param2, param3, false);
    }
