...
/**
 * \if ENGLISH_LANG
 * {@link EM_FILE_QUERY_TYPE#SDK_FILE_QUERY_FACE}  Corresponding Target recognition service search parameter
 * \else
 * {@link EM_FILE_QUERY_TYPE#SDK_FILE_QUERY_FACE} 对应的目标识别服务查询参数
 * \endif
 */
