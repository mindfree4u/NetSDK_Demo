...
public class MEDIA_QUERY_TRAFFICCAR_PARAM implements Serializable {
	...
	/**
	 * \if ENGLISH_LANG
	 * Plate type,"Unknown" ,"Normal" ,"Yellow" ,"DoubleYellow" ,"Police" ,"AD","ML","DoubleML"
	 * ,"SAR", "Trainning", "Personal", "Agri", "Embassy", "Moto", "Tractor", "Other"
	 * \else
 	 * 车牌类型，"Unknown" 未知,"Normal" 蓝牌黑牌,"Yellow" 黄牌,"DoubleYellow" 双层黄尾牌,"Police" 警牌"AD" 武警牌,
	...
	/**
	 * \if ENGLISH_LANG
	 * Vehicle mark, such as "Unknown"-unknown... NULL means field no use
	 * \else
	 * 车辆标识, 例如 "Unknown"-未知... NULL表示该字段不起作用
	 * \endif
	 */
