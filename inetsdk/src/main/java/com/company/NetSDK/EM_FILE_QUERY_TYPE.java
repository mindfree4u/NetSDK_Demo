...
public class EM_FILE_QUERY_TYPE implements Serializable {
	 ...
	 * \else
	 * 文件信息扩展 {@link NET_IN_MEDIA_QUERY_FILE} 和 {@link NET_OUT_MEDIA_QUERY_FILE}
	 * \endif
	 */
	...
	/**
	 * \if ENGLISH_LANG
	 * Intelligent dynamic monitoring (SMD) video query, corresponding to {@link MEDIAFILE_SMD_RECORD_FILE_PARAM} and {@link MEDIAFILE_SMD_RECORD_FILE_INFO}
	 * \else
	 * 智能动态监测(SMD) 录像查询, {@link MEDIAFILE_SMD_RECORD_FILE_PARAM} 和 {@link MEDIAFILE_SMD_RECORD_FILE_INFO}
	 * \endif
	 */
	...
	/**
	 * \if ENGLISH_LANG
	 * Find recordings by candidate or examination room information, corresponding to {@link NET_MEDIAFILE_EXAM_PARAM} and {@link NET_MEDIAFILE_EXAM_INFO}
	 * \else
	 * 按照考生或考场信息查找录像, {@link NET_MEDIAFILE_EXAM_PARAM} 和 {@link NET_MEDIAFILE_EXAM_INFO}
	 * \endif
	 */
