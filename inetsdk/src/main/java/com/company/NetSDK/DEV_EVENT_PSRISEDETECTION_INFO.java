...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_PSRISEDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_PSRISEDETECTION} (囚犯起身事件) 对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_PSRISEDETECTION_INFO implements Serializable {
	/**
	 *
	 */
	...
	public DEV_EVENT_PSRISEDETECTION_INFO() {
