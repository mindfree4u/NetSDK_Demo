...
/**
 * \if ENGLISH_LANG
 * Event type DH_EVENT_TAKENAWAYDETECTION (Object move event) corresponding data block description information
 * \else
 * 事件类型DH_EVENT_TAKENAWAYDETECTION (物品搬移事件) 对应的数据块描述信息
 * \endif
 */
public class ALARM_TAKENAWAY_DETECTION_INFO implements Serializable {
