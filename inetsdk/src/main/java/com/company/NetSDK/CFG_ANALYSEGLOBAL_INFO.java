...
public class CFG_ANALYSEGLOBAL_INFO implements Serializable{
	...
	/**
	 * \if ENGLISH_LANG
	 * The scene of measure body temperature
	 * \else
	 * 人体测温场景配置
	 * \endif
	 */
	public CFG_DETAIL_DRIVEASSISTANT_INFO	stuDriveAssistant = new CFG_DETAIL_DRIVEASSISTANT_INFO();
